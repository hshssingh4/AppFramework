...
public class AppGUI implements AppStyleArbiter 
{
    ...
    protected Button exportToPhotoButton;
    protected Button exportToCodeButton;
	...
	exitButton.setDisable(false);
        ...
        exportToPhotoButton.setDisable(false);
        exportToCodeButton.setDisable(false);
    ...
    private void initFileToolbar(AppTemplate app) 
    {
        ...
        newButton = initChildButton(fileToolbarPane,	NEW_ICON.toString(), 
                NEW_TOOLTIP.toString(),	false);
        loadButton = initChildButton(fileToolbarPane,	LOAD_ICON.toString(), 
                LOAD_TOOLTIP.toString(), false);
        saveButton = initChildButton(fileToolbarPane,	SAVE_ICON.toString(), 
                SAVE_TOOLTIP.toString(), true);
        saveAsButton = initChildButton(fileToolbarPane,	SAVE_AS_ICON.toString(), 
                SAVE_AS_TOOLTIP.toString(), true);
        exportToPhotoButton = initChildButton(fileToolbarPane,	EXPORT_TO_PHOTO_ICON.toString(), 
                EXPORT_TO_PHOTO_TOOLTIP.toString(), true);
        exportToCodeButton = initChildButton(fileToolbarPane,	EXPORT_TO_CODE_ICON.toString(), 
                EXPORT_TO_CODE_TOOLTIP.toString(), true);
        exitButton = initChildButton(fileToolbarPane,	EXIT_ICON.toString(), 
                EXIT_TOOLTIP.toString(), false);
	...
	// AND NOW SETUP THEIR EVENT HANDLERS
        ...
        exportToPhotoButton.setOnAction(e -> {
            fileController.handleExportToPhotoRequest();
        });
        exportToCodeButton.setOnAction(e -> {
